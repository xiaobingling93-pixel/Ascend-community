...
<table class="command">
    ...
    <tbody>
        ...
        <tr>
           ...
           <td>
                触发前冒烟。
                前冒烟通过后，该Pull Request会被打上<strong>st-success</strong>的标签。若前冒烟失败，该Pull Request会被打上<strong>st-fail</strong>的标签。
           </td>
           <td>
              所有开发者
           </td>
        ...
        <tr>
            ...
            <td>
              仓库所属sig组的Maintainers和Committers和Reviewers
            </td>reviewers
            <td>
                所有仓库
            </td>
        ...
        <tr>
            ...
            <td>
                <strong>Pull Request</strong>approved
            </td>
            <td>
                添加用于代表sig组的Maintainers和Committers同意合并的标签 <strong>approved</strong>。      
            </td>
            <td>
              仓库所属sig组的Maintainers和Committers
            </td>
            <td>
                所有仓库
            </td>
        ...
        <tr>
            ...
            <td>
                移除用于代表sig组的Maintainers和Committers同意合并的标签<strong>approved</strong>。
            </td>
            <td>
              仓库所属sig组的Maintainers和Committers
            </td>
        ...
        <tr>
            ...
            <td>
                仓库管理员可以直接添加；其他人可以使用评论添加标签，如kind/bug，前提是仓库中必须存在此标签，否则添加不上
            </td>
            <td>
                所有仓库
            </td>
        ...
        <tr>
            ...
            <td>
                仓库管理员可以直接添加；其他人可以使用评论添加标签，如kind/doc，前提是仓库中必须存在此标签，否则添加不上
            </td>
            <td>
                所有仓库
            </td>
        ...
        <tr>
            ...
            <td>
                添加标签 <strong>sig/doc</strong>。
            </td>
            <td>
                仓库管理员可以直接添加；其他人可以使用评论添加标签，如sig/doc，前提是仓库中必须存在此标签，否则添加不上
            </td>
            <td>
                所有仓库
            </td>
