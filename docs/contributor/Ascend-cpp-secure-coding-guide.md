...
本规范参考[OpenHarmony C&C++ 安全编程指南](https://gitcode.com/openharmony/docs/blob/master/zh-cn/contribute/OpenHarmony-c-cpp-secure-coding-guide.md)、[OpenEuler社区安全编程指南](https://gitee.com/openeuler/security-committee/blob/master/docs/zh/developer-guide/SecureCoding.md)、[CANN社区安全编码规范](https://gitcode.com/cann/community/blob/master/contributor/coding-standards/SecureCoding.md)整理而成，给参与Ascend开源社区项目的开发者提供安全编程指导。
