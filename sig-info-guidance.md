...
上诉branch_configs 列表中的每一条记录可包含如下元素：
| 字段 | 类型 | 层级|说明 |
|--|--|--|--|
...
上诉entry_configs 列表中的每一条记录可包含如下元素：
| 字段 | 类型 | 层级|说明 |
|--|--|--|--|
| path | 列表 |-| 目录或者文件列表, 可选 |
...
上诉mentors、committers、reviewers、branch_keeper、contributors的每一条个人信息记录包含如下元素：
| 字段 | 类型 | 层级|说明 |
|--|--|--|--|
...
- gitcode_id: aaa
- gitcode_id: bbb
committers:                            #SIG组所有committer名单 （ccc和ddd拥有MindI sig组下除了MindIE-Turbo、MinIE-LLM仓库以外的其它仓库的committer权限）
- gitcode_id: ccc
- gitcode_id: ddd
reviewers:                            #SIG组所有reviewer名单 （eee和fff拥有MindI sig组下除了MindIE-Turbo、MinIE-LLM仓库以外的其它仓库的reviewer权限）
- gitcode_id: eee
- gitcode_id: fff
repositories:                         #repositories 字段会说明SIG组所管理的仓库组的信息
- repo:                               #仓库组，可以是一个仓库，也可以是一组仓库 ，可选字段
  - Ascend/MindIE-Turbo
  - Ascend/MinIE-LLM
  committers:                          #仓库组对应的committer名单 ，可选字段 （ggg和hhh拥有MindIE-Turbo、MinIE-LLM仓库的committer权限）
  - gitcode_id: ggg
  - gitcode_id: hhh
  reviewers:                          #仓库组对应的reviewer名单 ，可选字段 （iii和jjj拥有MindIE-Turbo、MinIE-LLM仓库的reviewer权限）
  - gitcode_id: iii
  - gitcode_id: jjj
```
...
- repo:                               #仓库组，可以是一个仓库，也可以是一组仓库 ，可选字段
  - Ascend/MindIE-Turbo
  - Ascend/MinIE-LLM
  committers:                          #仓库组对应的committer名单 ，可选字段 （ggg和hhh拥有MindIE-Turbo、MinIE-LLM仓库下除了cmake/figures目录和siginfo.yaml文件的committer权限）
  - gitcode_id: ggg
  - gitcode_id: hhh
  reviewers:                          #仓库组对应的reviewer名单 ，可选字段 （ggg和hhh拥有MindIE-Turbo、MinIE-LLM仓库下除了cmake/figures目录和siginfo.yaml文件的reviewer权限）
  - gitcode_id: iii
  - gitcode_id: jjj
  ...
  - path:                             #entry组，可以是一个目录或者完整的文件路径，也可以是一组目录或者完整的文件路径，可选字段
    - cmake/figures
    - siginfo.yaml
    committers:                        #entry组对应的committer名单 ，可选字段 （yyy和zzz拥有MindIE-Turbo、MinIE-LLM仓库下cmake/figures目录和siginfo.yaml文件的committer权限）
    - gitcode_id: yyy
    - gitcode_id: zzz
    reviewers:                        #entry组对应的reviewer名单 ，可选字段 （qwe和rty拥有MindIE-Turbo、MinIE-LLM仓库下cmake/figures目录和siginfo.yaml文件的reviewer权限）
    - gitcode_id: qwe
    - gitcode_id: rty
...
- repo:                               #仓库组，可以是一个仓库，也可以是一组仓库 ，可选字段
  - Ascend/MindIE-Turbo
  - Ascend/MinIE-LLM
  committers:                          #仓库组对应的committer名单 ，可选字段 （ggg和hhh拥有MindIE-Turbo、MinIE-LLM仓库除了master、br_release分支的committer权限）
  - gitcode_id: ggg
  - gitcode_id: hhh
  reviewers:                          #仓库组对应的reviewer名单 ，可选字段 （iii和jjj拥有MindIE-Turbo、MinIE-LLM仓库除了master、br_release分支的reviewer权限）
  - gitcode_id: iii
  - gitcode_id: jjj
  ...
  - branch:                           #分支组，可以是一个分支，也可以是一组分支，可选字段
    - master
    - br_release
    committers:                        #分支组对应的committer名单 ，可选字段 （kkk和LLL拥有MindIE-Turbo、MinIE-LLM仓库master、br_release分支的committer权限）
    - gitcode_id: kkk
    - gitcode_id: LLL
    reviewers:                        #分支组对应的reviewer名单 ，可选字段 （mmm和nnn拥有MindIE-Turbo、MinIE-LLM仓库master、br_release分支的reviewer权限）
    - gitcode_id: mmm
    - gitcode_id: nnn
...
- repo:                               #仓库组，可以是一个仓库，也可以是一组仓库 ，可选字段
  ...
  - branch:                           #分支组，可以是一个分支，也可以是一组分支，可选字段
    ...
    - path:                           #entry组，可以是一个目录或者完整的文件路径，也可以是一组目录或者完整的文件路径，可选字段
      - cmake/figures
      - siginfo.yaml
      committers:                      #entry组对应的committer名单 ，可选字段 （qqq和rrr拥有MindIE-Turbo、MinIE-LLM仓库master和br_release分支下cmake/figures目录和siginfo.yaml文件的committer权限）
      - gitcode_id: qqq
      - gitcode_id: rrr
      reviewers:                      #entry组对应的reviewer名单 ，可选字段 （sss和ttt拥有MindIE-Turbo、MinIE-LLM仓库master和br_release分支下cmake/figures目录和siginfo.yaml文件的reviewr权限）
      - gitcode_id: sss
      - gitcode_id: ttt
